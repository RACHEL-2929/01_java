...
public class Application03 {
    public static void main(String[] args) {
        ...
        * */
        ...
        String[] empArr4 = emp3.split("/",-1);//음수를 넣어주면 구분자 뒤에 값이 없어도 넣어준다.
        ...
        while(st1.hasMoreTokens()){
            //한 번 확인하고 지워버리기 때문에 다시 출력하는 것이 불가능하다
            System.out.println("st1 : " + st1.nextToken());
        }

        String colorStr = "red*orange#blue/yellow green";
        //정규표현식이 존재하지 않아서 split 은 사용할 수 없다.
        // String[] color = colorStr.split("*#/");
        String[] colors = colorStr.split("[*#/ ]");
        //그러나 대괄호로 묶어서 사용한다면 사용가능하다.
