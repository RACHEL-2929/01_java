...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 모든 메소드는 static 메소드로 정의되어있다.*/
        ...
        System.out.println("-7의 절대값 : " + (java.lang.Math.abs(-7)));//abs 절대값
         ...
         * */
        //난수 발생 0~10
        //원래는 double 0.xxxx이런 형태인데 *10하고 int로 소수점 버림
        //0~10까지면 *10 0~100까지면 *100 이런식
        System.out.println("난수 발생 : "+(int)(Math.random()*10));

        Random random = new Random();
        int randomNumber = random.nextInt(20);
        System.out.println("난수 발생 버전 2: "+randomNumber);
