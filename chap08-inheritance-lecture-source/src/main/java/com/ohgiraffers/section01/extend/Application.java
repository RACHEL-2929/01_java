...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        //자동으로 super 를 기본 생성자에 넣어줘서 부모 기본 생성자도 호출됨
        RacingCar racingCar = new RacingCar();
        racingCar.run();        racingCar.soundHorn();
        racingCar.stop();
